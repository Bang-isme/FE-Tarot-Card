    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          <Route path={path.PUBLIC.FORUM} element={<ForumPage />} />
          <Route path={path.PUBLIC.FORUM_POST} element={<ForumPostDetailPage />} />
          <Route path={path.PUBLIC.FORUM_CREATE_POST} element={<CreateForumPostPage />} />
          <Route path={path.PUBLIC.FORUM_EDIT_POST} element={<EditForumPostPage />} />
