...
const SectionTitle = memo(
  ({ title, subtitle, centered = false, light = true }) => (
    <div className={`mb-8 ${centered ? "text-center" : ""}`}>
      <h2
        className={`text-3xl md:text-4xl font-bold mb-4 ${
          light ? "text-white" : "text-[#9370db]"
        } tracking-vn-tight`}
      >
        {title}
      ...
      {subtitle && (
        <p
          ...
          } text-lg tracking-vn-tight leading-vn`}
        >
          {subtitle}
        </p>
      )}
  ...
  <div className="bg-white/5 backdrop-blur-sm border border-purple-900/20 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:bg-white/10">
    <div className="grid grid-cols-1 md:grid-cols-3">
      ...
      <div className="p-6 md:col-span-2">
        ...
        <h3 className="text-xl font-bold mb-3 text-white tracking-vn-tight">
          Kết quả: {result}
        </h3>
...
const MysticBackground = memo(() => (
  <div className="absolute inset-0 pointer-events-none overflow-hidden">
    ...
    <div
      className="absolute bottom-40 left-[15%] w-72 h-72 bg-[#8a2be2]/10 rounded-full filter blur-[100px] animate-pulse-slow"
      style={{ animationDelay: "2s" }}
    ></div>
    <div className="absolute top-[40%] left-[30%] w-2 h-2 bg-white rounded-full animate-twinkle"></div>
    <div
      className="absolute top-[20%] right-[25%] w-2 h-2 bg-white rounded-full animate-twinkle"
      style={{ animationDelay: "1s" }}
    ></div>
    <div
      className="absolute bottom-[30%] right-[40%] w-2 h-2 bg-white rounded-full animate-twinkle"
      style={{ animationDelay: "2s" }}
    ></div>
  </div>
));
...
const ReadingHistoryPage = () => {
  ...
  const mockReadings = [
    ...
    },
    {
      ...
      image:
        "https://api-prod-minimal-v510.vercel.app/assets/images/travel/travel_5.jpg",
      category: "career",
    },
    {
      id: 6,
      ...
      image:
        "https://api-prod-minimal-v510.vercel.app/assets/images/travel/travel_6.jpg",
      category: "health",
    },
  ];
  ...
  const filterReadings = () => {
    return readings.filter((reading) => {
      // Filter by category
      const categoryMatch =
        activeFilter === "all" || reading.category === activeFilter;
  ...
  const itemsPerPage = 10; // ví dụ: 10 readings mỗi trang
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a0933] to-[#0f051d] text-white relative overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="Xem lại lịch sử các lần xem bói Tarot của bạn, từ tình yêu, sự nghiệp đến sức khỏe."
        />
      </Helmet>
            ...
            <div className="lg:col-span-1 order-2 lg:order-1">
              <div className="sticky top-24 space-y-8">
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-purple-900/20 rounded-xl p-6">
                  <h3 className="text-xl font-bold text-white tracking-vn-tight mb-4">
                    Thống kê
                  </h3>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center pb-2 border-b border-purple-900/20">
                      <p className="text-gray-300 tracking-vn-tight">
                        Tổng số lần xem
                      </p>
                      <p className="text-white font-medium tracking-vn-tight">
                        {stats.total}
                      </p>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-purple-900/20">
                ...
                <div className="bg-gradient-to-r from-[#2a1045] to-[#3a1c5a] rounded-xl p-6 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-xl font-bold text-white tracking-vn-tight mb-3">
                      Xem bói ngay
                    </h3>
              ...
              <div className="space-y-6">
                {filteredReadings.length > 0 ? (
                  ...
                  <div className="text-center py-12 bg-white/5 backdrop-blur-sm border border-purple-900/20 rounded-xl">
                    ...
                    <p className="text-xl text-gray-400 tracking-vn-tight mb-4">
                      Không tìm thấy lịch sử xem bói phù hợp.
                    </p>
                    <Link
                      to="/tarot-readings"
                ...
                <div className="flex justify-center mt-10">
                  <nav className="flex items-center space-x-2">
                    <button
                      ...
                      className="w-10 h-10 rounded-md flex items-center justify-center bg-white/10 text-white hover:bg-white/20 transition-colors disabled:opacity-30"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5"
